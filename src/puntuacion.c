...
#define MAX_PREGUNTAS 100 // Define MAX_PREGUNTAS
...
int main() {
    ...
    int numPreguntas = leerPreguntasDesdeArchivo("preguntas.txt", banco_Preguntas, MAX_PREGUNTAS); // Especifica el nombre del archivo
